  ...
  return (
    <>
      ...
      <Container fluid="sm">
          ...
          <Row className="align-items-center">
            ...
            <Col xs="5">
              ...
              <InputGroup className="mb-1">
                ...
                <Form.Control
                  name="from"
                  onChange={(e) => {  setState({ ...state, from: e.target.value, fromToResult: null }) }}
            ...
            <Col xs="5">
              ...
              <InputGroup className="mb-1">
                ...
                <Form.Control
                  onChange={(e) => { setState({ ...state, to: e.target.value, fromToResult: null  }) }}
                  id="inlineFormInputGroup" placeholder="for e.g 100" />
              </InputGroup>
            </Col>
        ...
        {state.fromToResult !== null && <Alert variant="info">
